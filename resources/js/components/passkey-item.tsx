    ...
    return (
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
            <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        افزوده شده {passkey.created_at_diff}
                        {passkey.last_used_at_diff && (
                            <>
                                <span className="mx-1 text-muted-foreground/50">
                                    /
                                </span>
                                آخرین استفاده {passkey.last_used_at_diff}
                            </>
                        )}
                    </p>
                </div>
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogTitle>حذف کلید عبور</DialogTitle>
                    <DialogDescription>
                        آیا مطمئن هستید که می‌خواهید کلید عبور «{passkey.name}»
                        را حذف کنید؟ دیگر نمی‌توانید از آن برای ورود استفاده
                        کنید.
                    </DialogDescription>
                    <DialogFooter className="gap-2">
                        ...
                        <Button
                            ...
                            disabled={isDeleting}
                        >
                            {isDeleting ? 'در حال حذف...' : 'حذف کلید عبور'}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
